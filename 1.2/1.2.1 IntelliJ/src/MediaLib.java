...
public class MediaLib
{
    public static void main(String args[])
    {
        ...
        MediaFile.writeString(song1.getTitle() + " Rating: " + song1.getRating());
        ...
        MediaFile.writeString(song9.getTitle() + " Rating: " + song9.getRating());

        Song song10 =  new Song("Hey Jude", .99, 9);
        numSongs = numSongs + 1;
        totalCost = totalCost + song10.getPrice();
        totalRating = totalRating + song10.getRating();
        MediaFile.writeString(song10.getTitle() + " Rating: " + song10.getRating());
